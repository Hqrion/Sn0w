...
extends Module {
    ...
    private void centerPlayer(double x, double y, double z) {
        AutoEchest.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayer.Position(x, y, z, true));
        AutoEchest.mc.field_71439_g.func_70107_b(x, y, z);
    }
    ...
    protected void onEnable() {
        if (AutoEchest.mc.field_71439_g == null) {
            this.disable();
            return;
        }
        BlockPos centerPos = AutoEchest.mc.field_71439_g.func_180425_c();
        this.playerPos = AutoEchest.mc.field_71439_g.func_174791_d();
        ...
        this.firstRun = true;
        this.playerHotbarSlot = AutoEchest.mc.field_71439_g.field_71071_by.field_70461_c;
    ...
    protected void onDisable() {
        ...
        if (this.lastHotbarSlot != this.playerHotbarSlot && this.playerHotbarSlot != -1) {
            AutoEchest.mc.field_71439_g.field_71071_by.field_70461_c = this.playerHotbarSlot;
        }
        if (this.isSneaking) {
            AutoEchest.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketEntityAction((Entity)AutoEchest.mc.field_71439_g, CPacketEntityAction.Action.STOP_SNEAKING));
    ...
    public void onUpdate() {
        if (AutoEchest.mc.field_71439_g == null || ModuleManager.isModuleEnabled("Freecam")) {
            return;
        }
        ...
        while (blocksPlaced < this.blocksPerTick.getValue()) {
            ...
            BlockPos targetPos = new BlockPos(AutoEchest.mc.field_71439_g.func_174791_d()).func_177982_a(offsetPos.field_177962_a, offsetPos.field_177960_b, offsetPos.field_177961_c);
    ...
    private boolean placeBlock(BlockPos pos) {
        Block block = AutoEchest.mc.field_71441_e.func_180495_p(pos).func_177230_c();
        if (!(block instanceof BlockAir) && !(block instanceof BlockLiquid)) {
            return false;
        }
        for (Entity entity : AutoEchest.mc.field_71441_e.func_72839_b(null, new AxisAlignedBB(pos))) {
        ...
        Block neighbourBlock = AutoEchest.mc.field_71441_e.func_180495_p(neighbour).func_177230_c();
        int obiSlot = this.findObiInHotbar();
        if (obiSlot == -1) {
            this.disable();
        }
        if (this.lastHotbarSlot != obiSlot) {
            AutoEchest.mc.field_71439_g.field_71071_by.field_70461_c = obiSlot;
            this.lastHotbarSlot = obiSlot;
        }
        if (!this.isSneaking && BlockInteractionHelper.blackList.contains(neighbourBlock) || BlockInteractionHelper.shulkerList.contains(neighbourBlock)) {
            AutoEchest.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketEntityAction((Entity)AutoEchest.mc.field_71439_g, CPacketEntityAction.Action.START_SNEAKING));
            this.isSneaking = true;
        }
        if (this.rotate.getValue().booleanValue()) {
            BlockInteractionHelper.faceVectorPacketInstant(hitVec);
        }
        AutoEchest.mc.field_71442_b.func_187099_a(AutoEchest.mc.field_71439_g, AutoEchest.mc.field_71441_e, neighbour, opposite, hitVec, EnumHand.MAIN_HAND);
        AutoEchest.mc.field_71439_g.func_184609_a(EnumHand.MAIN_HAND);
        AutoEchest.mc.field_71467_ac = 4;
        if (this.noGlitchBlocks.getValue().booleanValue() && !AutoEchest.mc.field_71442_b.func_178889_l().equals((Object)GameType.CREATIVE)) {
            AutoEchest.mc.field_71439_g.field_71174_a.func_147297_a((Packet)new CPacketPlayerDigging(CPacketPlayerDigging.Action.START_DESTROY_BLOCK, neighbour, opposite));
    ...
    private int findObiInHotbar() {
        ...
        for (int i = 0; i < 9; ++i) {
            Block block;
            ItemStack stack = AutoEchest.mc.field_71439_g.field_71071_by.func_70301_a(i);
