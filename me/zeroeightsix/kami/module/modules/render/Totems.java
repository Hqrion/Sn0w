...
extends Module {
    ...
    public void onRender() {
        ...
        if (this.smooth.getValue().booleanValue()) {
            ...
            Wrapper.getMinecraft().field_71466_p.func_175063_a("Totems " + KamiMod.getInstance().guiManager.getHUDTextColor() + totems, this.x.getValue().floatValue(), (yCount += 10.0f) - (float)Wrapper.getMinecraft().field_71466_p.field_78288_b, color);
        }
    }
}
