...
public final class Bytecode {
    ...
    public static String getBoxingType(Type type2) {
        return type2 == null ? null : BOXING_TYPES[type2.getSort()];
    }

    public static String getUnboxingMethod(Type type2) {
        return type2 == null ? null : UNBOXING_METHODS[type2.getSort()];
    }
    ...
    private static List<AnnotationNode> mergeAnnotations(List<AnnotationNode> from, List<AnnotationNode> to, String type2, String name) {
        try {
            if (from == null) {
                return to;
            }
            ...
            logger.warn("Exception encountered whilst merging annotations for {} {}", new Object[]{type2, name});
        }
        return to;
    }
