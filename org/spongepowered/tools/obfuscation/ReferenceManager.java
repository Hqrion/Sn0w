...
implements IReferenceManager {
    ...
    protected void addMapping(ObfuscationType type2, String className, String reference, String newReference) {
        String oldReference = this.refMapper.addMapping(type2.getKey(), className, reference, newReference);
        if (type2.isDefault()) {
