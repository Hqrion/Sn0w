...
extends MappingWriter {
     ...
     */
    @Override
    public void write(String output, ObfuscationType type2, IMappingConsumer.MappingSet<MappingField> fields, IMappingConsumer.MappingSet<MappingMethod> methods) {
        if (output == null) {
            return;
        }
        PrintWriter writer = null;
        try {
            writer = this.openFileWriter(output, type2 + " output SRGs");
