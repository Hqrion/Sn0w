...
extends TypeHandle {
    ...
    public TypeHandleSimulated(String name, TypeMirror type2) {
        this(TypeUtils.getPackage(type2), name, type2);
    }

    public TypeHandleSimulated(PackageElement pkg, String name, TypeMirror type2) {
        super(pkg, name);
    ...
    public FieldHandle findField(String name, String type2, boolean caseSensitive) {
        return new FieldHandle(null, name, type2);
    }
