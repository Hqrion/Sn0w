...
public class TypeHandle {
    ...
    public TypeHandle(DeclaredType type2) {
        this((TypeElement)type2.asElement());
    }
    ...
    public final FieldHandle findField(String name, String type2) {
        return this.findField(name, type2, true);
    }

    public FieldHandle findField(String name, String type2, boolean caseSensitive) {
        String rawType = TypeUtils.stripGenerics(type2);
        for (VariableElement field : this.getEnclosedElements(ElementKind.FIELD)) {
            if (TypeHandle.compareElement(field, name, type2, caseSensitive)) {
    ...
    protected static boolean compareElement(Element elem, String name, String type2, boolean matchCase) {
        try {
            ...
            return compared && (type2.length() == 0 || type2.equals(elementType) || type2.equals(rawElementType));
        }
