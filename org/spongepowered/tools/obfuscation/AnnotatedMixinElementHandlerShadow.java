...
extends AnnotatedMixinElementHandler {
    ...
    private void registerShadowForTarget(AnnotatedElementShadow<?, ?> elem, TypeHandle target) {
        ...
        for (ObfuscationType type2 : obfData) {
            try {
                elem.addMapping(type2, (IMapping)obfData.get(type2));
            }
    ...
    extends AnnotatedElementShadow<ExecutableElement, MappingMethod> {
        ...
        @Override
        public void addMapping(ObfuscationType type2, IMapping<?> remapped) {
            AnnotatedMixinElementHandlerShadow.this.addMethodMapping(type2, this.setObfuscatedName(remapped), this.getDesc(), remapped.getDesc());
        }
    }
    ...
    extends AnnotatedElementShadow<VariableElement, MappingField> {
        ...
        @Override
        public void addMapping(ObfuscationType type2, IMapping<?> remapped) {
            AnnotatedMixinElementHandlerShadow.this.addFieldMapping(type2, this.setObfuscatedName(remapped), this.getDesc(), remapped.getDesc());
        }
    }
    ...
    extends AnnotatedMixinElementHandler.AnnotatedElement<E> {
        ...
        protected AnnotatedElementShadow(E element, AnnotationHandle annotation, boolean shouldRemap, IMapping.Type type2) {
