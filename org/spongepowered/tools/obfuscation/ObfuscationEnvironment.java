...
implements IObfuscationEnvironment {
    ...
    protected ObfuscationEnvironment(ObfuscationType type2) {
        this.type = type2;
        this.ap = type2.getAnnotationProcessor();
        this.inFileNames = type2.getInputFileNames();
        this.outFileName = type2.getOutputFileName();
    ...
    public MappingMethod getObfMethod(MemberInfo method) {
        ...
        TypeHandle type2 = this.ap.getTypeProvider().getTypeHandle(method.owner);
        if (type2 == null || type2.isImaginary()) {
            return null;
        }
        TypeMirror superClass = type2.getElement().getSuperclass();
