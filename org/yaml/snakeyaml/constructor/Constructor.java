...
extends SafeConstructor {
    ...
    extends AbstractConstruct {
        ...
        public Object construct(Node nnode) {
            ...
            try {
                return Constructor.this.newInstance(type2, node, false);
            }
                ...
                if (type2.isPrimitive() || type2 == String.class || Number.class.isAssignableFrom(type2) || type2 == Boolean.class || Date.class.isAssignableFrom(type2) || type2 == Character.class || type2 == BigInteger.class || type2 == BigDecimal.class || Enum.class.isAssignableFrom(type2) || Tag.BINARY.equals(node.getTag()) || Calendar.class.isAssignableFrom(type2) || type2 == UUID.class) {
                    ...
                    if (javaConstructor == null) {
                        try {
                            ...
                            throw new YAMLException("No single argument constructor found for " + type2 + " : " + ie.getMessage());
                        }
                    }
                    if (oneArgCount == 1) {
        ...
        private Object constructStandardJavaInstance(Class type2, ScalarNode node) {
            ...
            if (type2 == String.class) {
                ...
                result = type2 == Byte.class || type2 == Byte.TYPE ? (Number)Byte.valueOf(result.toString()) : (Number)(type2 == Short.class || type2 == Short.TYPE ? (Number)Short.valueOf(result.toString()) : (Number)(type2 == Integer.class || type2 == Integer.TYPE ? (Number)Integer.parseInt(result.toString()) : (Number)(type2 == Long.class || type2 == Long.TYPE ? Long.valueOf(result.toString()) : new BigInteger(result.toString()))));
