...
extends CtMember {
    ...
    public CtField(CtClass type2, String name, CtClass declaring) throws CannotCompileException {
        this(Descriptor.of(type2), name, declaring);
    }
    ...
    extends Initializer {
        ...
        @Override
        int compile(CtClass type2, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
            code.addAload(0);
        ...
        @Override
        int compileIfStatic(CtClass type2, String name, Bytecode code, Javac drv) throws CannotCompileException {
            int s = code.addMultiNewarray(type2, this.dim);
    ...
    extends Initializer {
        ...
        @Override
        int getConstantValue(ConstPool cp, CtClass type2) {
            if (type2.getName().equals(CtField.javaLangString)) {
    ...
    extends NewInitializer {
        ...
        int compile(CtClass type2, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
            ...
            String typeDesc = Descriptor.of(type2);
    ...
    extends Initializer {
        ...
        int compile(CtClass type2, String name, Bytecode code, CtClass[] parameters, Javac drv) throws CannotCompileException {
            if (parameters != null && this.nthParam < parameters.length) {
                ...
                int s = code.addLoad(nth, type2) + 1;
                code.addPutfield(Bytecode.THIS, name, Descriptor.of(type2));
                return s;
            }
            return 0;
        ...
        static int nthParamToLocal(int nth, CtClass[] params, boolean isStatic) {
            ...
            int k = isStatic ? 0 : 1;
            for (int i = 0; i < nth; ++i) {
                CtClass type2 = params[i];
                if (type2 == longType || type2 == doubleType) {
                    k += 2;
                    continue;
                }
                ++k;
    ...
    extends CodeInitializer0 {
        ...
        @Override
        int getConstantValue(ConstPool cp, CtClass type2) {
            return this.getConstantValue2(cp, type2, this.expression);
        }
    }
    ...
    extends CodeInitializer0 {
        ...
        int getConstantValue(ConstPool cp, CtClass type2) {
            try {
                ...
                return this.getConstantValue2(cp, type2, t);
            }
            catch (CompileError e) {
                return 0;
            }
    ...
    extends Initializer {
        ...
        int getConstantValue2(ConstPool cp, CtClass type2, ASTree tree) {
            ...
            } else if (tree instanceof StringL && type2.getName().equals("java.lang.String")) {
    ...
    public static abstract class Initializer {
        ...
        public static Initializer byNewArray(CtClass type2, int size) throws NotFoundException {
            return new ArrayInitializer(type2.getComponentType(), size);
        }

        public static Initializer byNewArray(CtClass type2, int[] sizes) {
            return new MultiArrayInitializer(type2, sizes);
        }
