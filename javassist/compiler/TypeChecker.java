...
TokenId {
    ...
    protected static StringBuffer typeToString(StringBuffer sbuf, int type2, int dim, String cname) {
        String s;
        if (type2 == 307) {
            ...
            try {
                s = MemberResolver.getTypeName(type2);
            }
    ...
    public void atNewArrayExpr(NewExpr expr) throws CompileError {
        ...
        if (size.length() > 1) {
            ...
            this.exprType = type2;
            this.arrayDim = 1;
            this.className = type2 == 307 ? this.resolveClassName(classname) : null;
        }
    }
    ...
    public void atIntConst(IntConst i) throws CompileError {
        this.arrayDim = 0;
        int type2 = i.getType();
        this.exprType = type2 == 402 || type2 == 401 ? (type2 == 402 ? 324 : 306) : 326;
    }
