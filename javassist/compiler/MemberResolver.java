...
implements TokenId {
     ...
     */
    public CtClass lookupClass(int type2, int dim, String classname) throws CompileError {
        String cname = "";
        if (type2 == 307) {
            ...
            cname = MemberResolver.getTypeName(type2);
        }
        while (dim-- > 0) {
            cname = cname + "[]";
        }
    ...
    static String getTypeName(int type2) throws CompileError {
        String cname = "";
        switch (type2) {
            case 301: {
                cname = "boolean";
