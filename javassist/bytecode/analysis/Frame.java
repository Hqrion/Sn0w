...
public class Frame {
    ...
    public void setLocal(int index, Type type2) {
        this.locals[index] = type2;
    }
    ...
    public void setStack(int index, Type type2) {
        this.stack[index] = type2;
    }
