...
extends AttributeInfo {
    ...
    static class SubWalker {
        ...
        final int targetInfo(int pos, int type2) throws Exception {
            switch (type2) {
                case 0: 
                case 1: {
                    int index = this.info[pos] & 0xFF;
                    this.typeParameterTarget(pos, type2, index);
                    return pos + 1;
                }
                case 16: {
                ...
                case 18: {
                    ...
                    this.typeParameterBoundTarget(pos, type2, param, bound);
                    return pos + 2;
                }
                case 19: 
                case 20: 
                case 21: {
                    this.emptyTarget(pos, type2);
                    return pos;
                }
                case 22: {
                    int index = this.info[pos] & 0xFF;
                ...
                case 65: {
                    ...
                    return this.localvarTarget(pos + 2, type2, len);
                }
                case 66: {
                    int index = ByteArray.readU16bit(this.info, pos);
                ...
                case 70: {
                    ...
                    this.offsetTarget(pos, type2, offset);
                    return pos + 2;
                }
                case 71: 
                case 72: 
                ...
                case 75: {
                    ...
                    this.typeArgumentTarget(pos, type2, offset, index);
                    return pos + 3;
                }
            }
            throw new RuntimeException("invalid target type: " + type2);
        }
